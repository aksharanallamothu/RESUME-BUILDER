           ...
           <div className="space-y-4">
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                     ...
                     <input value={education.degree || ""} onChange={(e)=>updateEducation(index, "degree", e.target.value)} type="text" placeholder="Degree (e.g., Bacherlor's Master's)" className="px-3 py-2 text-sm" />
